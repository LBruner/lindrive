...
exports.deleteCloudFile = exports.renameFolder = exports.updateCloudFile = exports.createDriveFolder = exports.uploadFile = void 0;
...
const renameFolder = (folderId, newName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield googleAuth_1.drive.files.update({
            fileId: folderId,
            resource: {
                name: newName
            }
