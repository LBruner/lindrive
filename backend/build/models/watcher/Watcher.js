...
class Watcher {
    ...
    get on() {
        return this.watcher.on;
    }
    getInitialNodes(rootCloudID) {
        return __awaiter(this, void 0, void 0, function* () {
            let descendingNodes;
            descendingNodes = yield this.getInitialFolders(rootCloudID);
            descendingNodes.push(...yield this.getInitialFiles());
            return descendingNodes;
        });
    }
    getInitialFolders(rootCloudID) {
        return __awaiter(this, void 0, void 0, function* () {
            const temporaryWatcher = chokidar_1.default.watch(this.path);
            const initialNodes = [];
            const promise = new Promise((resolve) => {
                temporaryWatcher.on('addDir', (eventName) => {
                    const folderNode = new FolderNode_1.FolderNode(eventName, rootCloudID);
