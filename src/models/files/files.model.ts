...
// import {getItemID, registerItem} from "./files.mysql";
...
//     let rootFolderID = await getItemID(folders[0].path);
...
//         const folderIsRegistered = await getItemID(folder.path);
//
...
// }
//
// export const getFolders = (folders: string[]) =>{
//     console.log()
// }
//
//
...
//
//
// export const processItem = (data: string[]) =>{
//     console.log(data)
//
// }